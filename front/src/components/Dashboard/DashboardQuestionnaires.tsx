...
import { UpcomingQuestionnaireDto, DashboardFilters } from '../../types/dashboard';

interface DashboardQuestionnairesProps {
  className?: string;
}

const DashboardQuestionnaires: React.FC<DashboardQuestionnairesProps> = ({ className }) => {
      ...
      <div className="p-6">
        {isLoading ? (
          ...
          <div className="space-y-4">
            {data?.questionnaires?.map((questionnaire: UpcomingQuestionnaireDto) => (
              <div
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-600 mb-2">
                      <span>
                        <strong>{questionnaire.supplierName}</strong> ({questionnaire.supplierCode})
                      </span>
                  ...
                  <div className="text-right ml-4">
                    ...
                    <div className={`text-xs mt-1 ${questionnaire.daysToDeadline < 0 ? 'text-red-600' : questionnaire.daysToDeadline <= 3 ? 'text-orange-600' : 'text-gray-600'}`}>
