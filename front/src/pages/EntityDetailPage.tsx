...
const EntityDetailPage: React.FC = () => {
  ...
  const [entity, setEntity] = React.useState<SupplyNetworkEntityDto | null>(
    null
  ); // State to hold entity data
  ...
  return (
    <div>
      <h2>
        {entity.legalName} ({entity.entityType})
      </h2>
      {/* Removed description field as it does not exist in SupplyNetworkEntityDto */}
      <p>{t("entityDetails.otherInfo")} Other entity details here.</p>{" "}
